      ...
      <div className="flex w-full">
        <div className="md:w-[80%] w-[75%]">
          ...
          <div className="w-full my-3 relative">
            ...
            <h1
              className="absolute lg:top-[10%] top-[25%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 lg:text-[35px] md:text-[26px] text-[20px] font-bold text-red-600 rounded-md px-1 py-1"
              style={{
        ...
        <div className="md:w-[20%] w-[25%] imagescroll overflow-hidden flex justify-center">
          <div className="animate-scroll flex flex-col">
            ...
            {images.map((img, index) => (
              <div
                key={`duplicate-${index}`}
                className="image-container border border-gray-400 my-1 rounded-md"
              >
