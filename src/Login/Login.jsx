...
const Login = () => {
  ...
  const handleLogin = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${BASE_URL}/api/CustomerLogin/loginUser`, {
        method: "POST",
        headers: {
                  ...
                  <CCardGroup>
                        ...
                        <CForm>
                          ...
                          <CRow>
                            <CCol xs={12} className="flex justify-center">
                              <CButton
                                className="px-4 bg-sky-800 hover:bg-sky-900 text-white mx-center border-none py-2"
                                onClick={handleLogin}
                              >
                                Login
                              </CButton>
                    ...
                    >
                      ...
                      <button
                        ...
                        className="w-[fit-content] py-2 px-2 rounded bg-sky-800 hover:bg-sky-900 text-white mb-1"
                      >
                        Register Now!
                      </button>
                    </CCard>
